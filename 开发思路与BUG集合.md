...
![image-20220311173420517](D:\GitTool\同步笔记\Typora_images\image-20220311173420517.png)

## 1.1、bug原因

**==在一个组件中定义了两个methods，所以,asyncGetUsers函数识别不到了...==**

![image-20220311173459828](D:\GitTool\同步笔记\Typora_images\image-20220311173459828.png)
...
![image-20220311175810214](D:\GitTool\同步笔记\Typora_images\image-20220311175810214.png)

## 2.1、问题解决：

![image-20220311180008602](D:\GitTool\同步笔记\Typora_images\image-20220311180008602.png)

**==<font color='red'>在axios的回调函数中调用组件中的方法时候要注意：这时候this指的是axios而不是组件本身！！！操了</font>==**

![image-20220311180228221](D:\GitTool\同步笔记\Typora_images\image-20220311180228221.png)
...
![image-20220311180957692](D:\GitTool\同步笔记\Typora_images\image-20220311180957692.png)
...
![image-20220311182447375](D:\GitTool\同步笔记\Typora_images\image-20220311182447375.png)
...
![image-20220311184710248](D:\GitTool\同步笔记\Typora_images\image-20220311184710248.png)
...
![image-20220311185803493](D:\GitTool\同步笔记\Typora_images\image-20220311185803493.png)
...
![image-20220311210908654](D:\GitTool\同步笔记\Typora_images\image-20220311210908654.png)
...
![image-20220311211520143](D:\GitTool\同步笔记\Typora_images\image-20220311211520143.png)



![image-20220311211603306](D:\GitTool\同步笔记\Typora_images\image-20220311211603306.png)
...
![image-20220311223249060](D:\GitTool\同步笔记\Typora_images\image-20220311223249060.png)
...
![image-20220311223359853](D:\GitTool\同步笔记\Typora_images\image-20220311223359853.png)
...
![image-20220312101703243](D:\GitTool\同步笔记\Typora_images\image-20220312101703243.png)
...
![image-20220312102558048](D:\GitTool\同步笔记\Typora_images\image-20220312102558048.png)

控制台输出：
![image-20220312102819870](D:\GitTool\同步笔记\Typora_images\image-20220312102819870.png)



### 10.1.3、错误打印对象

![image-20220312102939012](D:\GitTool\同步笔记\Typora_images\image-20220312102939012.png)

控制台：
![image-20220312103010364](D:\GitTool\同步笔记\Typora_images\image-20220312103010364.png)

对象信息就出不来了，妈的真的服了...

## 10.2、子bug2

![image-20220312103159998](D:\GitTool\同步笔记\Typora_images\image-20220312103159998.png)
...
处理：
![image-20220312103931830](D:\GitTool\同步笔记\Typora_images\image-20220312103931830.png)
...
![image-20220312114358114](D:\GitTool\同步笔记\Typora_images\image-20220312114358114.png)



不能谋全局者不能谋一时，不能谋万世者不能谋一时！对于开发来说也是如此啊！如果我们重新写一个接口，在点击查询的时候触发这个接口然后从后端获取数据，更新state仓库虽然实现了功能，但有一些问题：

1、![image-20220312115146302](D:\GitTool\同步笔记\Typora_images\image-20220312115146302.png)

所以点击后就会出现原来的数据了。。。

2、解决：**==不要新写一个接口，还是调用原来的函数接口，只不过条件不一样了，然后改变axios访问的后端接口就行了==**

![image-20220312115901197](D:\GitTool\同步笔记\Typora_images\image-20220312115901197.png)
...
![image-20220312120803522](D:\GitTool\同步笔记\Typora_images\image-20220312120803522.png)
...
![image-20220312133542990](D:\GitTool\同步笔记\Typora_images\image-20220312133542990.png)
...
![image-20220312134331841](D:\GitTool\同步笔记\Typora_images\image-20220312134331841-16470638149001.png)
...
![image-20220312163348958](D:\GitTool\同步笔记\Typora_images\image-20220312163348958.png)

==可见在java中，字符串的比较不能直接用\=\= 的==

解决办法：使用compareTo函数判断比较即可

![image-20220312171553075](D:\GitTool\同步笔记\Typora_images\image-20220312171553075.png)
...
![image-20220312211555506](D:\GitTool\同步笔记\Typora_images\image-20220312211555506.png)
...
![image-20220313082659000](D:\GitTool\同步笔记\Typora_images\image-20220313082659000.png)

使用postman测试后端的端口发现后端已经正常工作了...

![image-20220313082949852](D:\GitTool\同步笔记\Typora_images\image-20220313082949852.png)
...
![image-20220313100845540](D:\GitTool\同步笔记\Typora_images\image-20220313100845540.png)

**==<font color='red'>像这种的后端post接口，前端只能通过form表单数据的提交方式，后端才能接受到：在postman中进行测试</font>==**

![image-20220313101129725](D:\GitTool\同步笔记\Typora_images\image-20220313101129725.png)

**==<font color='red'>后端要想接受json串，那就要把接受的参数进行封装，然后使用@RequestBody注解接受json串，再然后使用get方法就可以访问json串中的内容了</font>==**



![image-20220313101838339](D:\GitTool\同步笔记\Typora_images\image-20220313101838339.png)

- postman测试一下

![image-20220313103224525](D:\GitTool\同步笔记\Typora_images\image-20220313103224525.png)
...
![image-20220313161940587](D:\GitTool\同步笔记\Typora_images\image-20220313161940587.png)
...
解决：
![image-20220313162128735](D:\GitTool\同步笔记\Typora_images\image-20220313162128735.png)
...
![image-20220313162708941](D:\GitTool\同步笔记\Typora_images\image-20220313162708941.png)
...
![image-20220314092417953](D:\GitTool\同步笔记\Typora_images\image-20220314092417953.png)

我希望在main组件中出现如下的效果：

![image-20220314092516087](D:\GitTool\同步笔记\Typora_images\image-20220314092516087.png)
...
![image-20220314093530917](D:\GitTool\同步笔记\Typora_images\image-20220314093530917.png)

<font color='purple'>默认开启录制功能，每隔24个小时就保存一次录制好的视频内容存放到本地的一个文件夹下面，然后可以通过历史记录来访问：</font>

![QQ截图20220314094507](D:\GitTool\同步笔记\Typora_images\QQ截图20220314094507.png)



## 17.2、用户管理模块

![image-20220314095639265](D:\GitTool\同步笔记\Typora_images\image-20220314095639265.png)
...
![image-20220314131848619](D:\GitTool\同步笔记\Typora_images\image-20220314131848619.png)
...
![image-20220314121829927](D:\GitTool\同步笔记\Typora_images\image-20220314121829927.png)

- 但是subItems明明有在Props中出现啊！！！
- **报错原因：箭头函数无法被识别：改成普通的函数就行了，服了什么错误都有，真的一坨屎山不要去改动他里面的代码，再在上面拉一坨走人就行了，艹**
  ![image-20220314121949925](D:\GitTool\同步笔记\Typora_images\image-20220314121949925.png)
...
![image-20220314214353579](D:\GitTool\同步笔记\Typora_images\image-20220314214353579.png)
...
![image-20220314222527870](D:\GitTool\同步笔记\Typora_images\image-20220314222527870.png)



![image-20220314222549764](D:\GitTool\同步笔记\Typora_images\image-20220314222549764.png)
...
![image-20220315083814122](D:\GitTool\同步笔记\Typora_images\image-20220315083814122.png)

**解决：因为调用的时候函数名写错了捏....就离大谱**

## 20.4、bug（逻辑bug）

![image-20220315090605483](D:\GitTool\同步笔记\Typora_images\image-20220315090605483.png)





![image-20220315090626264](D:\GitTool\同步笔记\Typora_images\image-20220315090626264.png)
...
![image-20220315092725682](D:\GitTool\同步笔记\Typora_images\image-20220315092725682.png)

- **<font color='purple'>这里有个小问题，就是当删除了数据之后，就重新回到了第一页，可如果用户是在第4页删除的数据呢？所以这里重新向服务器发起请求的时候应该携带上之前页面状态的参数才对捏</font>**

- 解决：

  ![image-20220322192224837](D:\GitTool\同步笔记\Typora_images\image-20220322192224837.png)
...
![image-20220315121633335](D:\GitTool\同步笔记\Typora_images\image-20220315121633335-16473177955351.png)

- **<font color='red'>导入一个对象，导出一个对象（{}在js中就是一个对象了）,注册导入的对象。在template中使用导入的对象。</font>**

**<font color='purple'>在java中的实现方式如下</font>**

![image-20220315122440755](D:\GitTool\同步笔记\Typora_images\image-20220315122440755.png)
...
![image-20220315124427967](D:\GitTool\同步笔记\Typora_images\image-20220315124427967.png)
...
![image-20220317162553212](D:\GitTool\同步笔记\Typora_images\image-20220317162553212.png)
...
![image-20220317165742070](D:\GitTool\同步笔记\Typora_images\image-20220317165742070.png)
...
![image-20220317174136205](D:\GitTool\同步笔记\Typora_images\image-20220317174136205.png)
...
![image-20220317201744415](D:\GitTool\同步笔记\Typora_images\image-20220317201744415.png)

- **<font color='red'>解决：这是因为我在postman里面只传递了一个参数，其他的参数还没有传。（不过有默认值的就可以不用传了捏，哈哈!!）</font>**

![image-20220317201843694](D:\GitTool\同步笔记\Typora_images\image-20220317201843694.png)
...
![image-20220318084502266](D:\GitTool\同步笔记\Typora_images\image-20220318084502266.png)
...
![image-20220318090533183](D:\GitTool\同步笔记\Typora_images\image-20220318090533183.png)
...
![image-20220322200321697](D:\GitTool\同步笔记\Typora_images\image-20220322200321697.png)
...
![image-20220322202034359](D:\GitTool\同步笔记\Typora_images\image-20220322202034359.png)
...
![image-20220322203936494](D:\GitTool\同步笔记\Typora_images\image-20220322203936494.png)
...
![image-20220318102929069](D:\GitTool\同步笔记\Typora_images\image-20220318102929069.png)

- **<font color='red'>bug原因</font>**

![image-20220318103009841](D:\GitTool\同步笔记\Typora_images\image-20220318103009841.png)
...
![image-20220318184517398](D:\GitTool\同步笔记\Typora_images\image-20220318184517398.png)
...
![image-20220318210256335](D:\GitTool\同步笔记\Typora_images\image-20220318210256335.png)
...
![image-20220318211144269](D:\GitTool\同步笔记\Typora_images\image-20220318211144269.png)

![image-20220318211221547](D:\GitTool\同步笔记\Typora_images\image-20220318211221547.png)
...
![image-20220318211524163](D:\GitTool\同步笔记\Typora_images\image-20220318211524163.png)
...
![image-20220318221629021](D:\GitTool\同步笔记\Typora_images\image-20220318221629021.png)



- **<font color='red'>解决：是因为webpack的语法错误了...</font>**

![image-20220318221751957](D:\GitTool\同步笔记\Typora_images\image-20220318221751957.png)

- **<font color='red'>导出模块的时候加上一个{}...</font>**

![image-20220318221842435](D:\GitTool\同步笔记\Typora_images\image-20220318221842435.png)
...
![image-20220319095306938](D:\GitTool\同步笔记\Typora_images\image-20220319095306938.png)
...
![image-20220322194149362](D:\GitTool\同步笔记\Typora_images\image-20220322194149362.png)

## 24.2、bug12（逻辑bug，无报错）

![image-20220319152939177](D:\GitTool\同步笔记\Typora_images\image-20220319152939177.png)
...
![image-20220319153319559](D:\GitTool\同步笔记\Typora_images\image-20220319153319559.png)
...
![image-20220319164557136](D:\GitTool\同步笔记\Typora_images\image-20220319164557136.png)
...
![image-20220320140958212](D:\GitTool\同步笔记\Typora_images\image-20220320140958212.png)
...
![image-20220321222050770](D:\GitTool\同步笔记\Typora_images\image-20220321222050770.png)



**<font color='red'>问题描述：就是删除一页的全部内容后，该页的内容会重新从数据库中获取的对吧，而重新获取到的内容再次选中删除后就报错了，就是上面的那个错，不知道为什么???</font>**

![image-20220322075635830](D:\GitTool\同步笔记\Typora_images\image-20220322075635830.png)
...
![image-20220322081150243](D:\GitTool\同步笔记\Typora_images\image-20220322081150243-16479079121931.png)

**<font color='purple'>前端每次发送的时候，ids都没有重新清空过，这就导致ids被发送到后端的时候，还携带上一次的数据和token信息（第二个框框），所以后端处理不了了就报错了。</font>**

![image-20220322081434048](D:\GitTool\同步笔记\Typora_images\image-20220322081434048.png)

**<font color='purple'>只要每次发送批量删除的请求后，再次进行重置ids中的所有内容就行了</font>**

![image-20220322082451278](D:\GitTool\同步笔记\Typora_images\image-20220322082451278.png)
...
![image-20220322093510151](D:\GitTool\同步笔记\Typora_images\image-20220322093510151.png)
...
![image-20220322090521571](D:\GitTool\同步笔记\Typora_images\image-20220322090521571.png)
...
![image-20220325125701255](D:\GitTool\同步笔记\Typora_images\image-20220325125701255.png)

**历史记录这里要写一些什么捏？因为在尾气检测这里就可以查看所有历史的图表了，所以历史记录就和以前一样使用使用查找的那个模板就行了，也比较简单。**

基本上就是这样的：

![image-20220325130123093](D:\GitTool\同步笔记\Typora_images\image-20220325130123093.png)
...
![image-20220326131813149](D:\GitTool\同步笔记\Typora_images\image-20220326131813149.png)
...
![image-20220326132514208](D:\GitTool\同步笔记\Typora_images\image-20220326132514208.png)

**<font color='purple'>按道理来说，在页面大小改变的时候，我去获取图表绑定div容器的宽和高，然后在resize的时候重新传递给exhasutChart对吧，那页面大小改变后图表的比例应该也是正确的呀</font>**

![image-20220326132845243](D:\GitTool\同步笔记\Typora_images\image-20220326132845243.png)
...
![image-20220331191526487](D:\GitTool\同步笔记\Typora_images\image-20220331191526487.png)
...
![image-20220327103305414](D:\GitTool\同步笔记\Typora_images\image-20220327103305414.png)
...
![image-20220327104227639](D:\GitTool\同步笔记\Typora_images\image-20220327104227639.png)
...
![image-20220327103722774](D:\GitTool\同步笔记\Typora_images\image-20220327103722774.png)
...
![image-20220328093651445](D:\GitTool\同步笔记\Typora_images\image-20220328093651445.png)
...
![image-20220328185742689](D:\GitTool\同步笔记\Typora_images\image-20220328185742689.png)
...
![image-20220329100844943](D:\GitTool\同步笔记\Typora_images\image-20220329100844943.png)

Controller层：
![image-20220329100950659](D:\GitTool\同步笔记\Typora_images\image-20220329100950659.png)
...
![image-20220329113817915](D:\GitTool\同步笔记\Typora_images\image-20220329113817915.png)

**<font color='red'>服务器中entity的大小写没有影响，主要就是传递的JSON数据的键，它的首字母必须小写捏</font>**



![image-20220329113936397](D:\GitTool\同步笔记\Typora_images\image-20220329113936397.png)
...
![image-20220329132037286](D:\GitTool\同步笔记\Typora_images\image-20220329132037286.png)

**<font color='red'>因为这个standardValue代表的是标准值，不用每次都从外边获取的，所以我就想设置它的默认值，这样每次增加里面的记录的时候然后就可以自动生成设置好的标准数值了捏</font>**

![image-20220329132442812](D:\GitTool\同步笔记\Typora_images\image-20220329132442812.png)

## 29.8、需求思路

![image-20220329154445945](D:\GitTool\同步笔记\Typora_images\image-20220329154445945.png)
...
![image-20220330094306674](D:\GitTool\同步笔记\Typora_images\image-20220330094306674.png)
...
![image-20220330094556554](D:\GitTool\同步笔记\Typora_images\image-20220330094556554.png)
...
![image-20220330094944267](D:\GitTool\同步笔记\Typora_images\image-20220330094944267.png)
...
![image-20220330130852553](D:\GitTool\同步笔记\Typora_images\image-20220330130852553.png)
...
![image-20220330131424070](D:\GitTool\同步笔记\Typora_images\image-20220330131424070.png)
...
![image-20220330132639289](D:\GitTool\同步笔记\Typora_images\image-20220330132639289.png)
...
![image-20220331151110474](D:\GitTool\同步笔记\Typora_images\image-20220331151110474.png)

**<font color='purple'>在getData函数中更新本地变量 thisD:\GitTool\同步笔记\_exhausts的值对吧，然后再mounted函数中执行这个函数，看看this._exhausts的值有没有改变。</font>**



![image-20220331151556724](D:\GitTool\同步笔记\Typora_images\image-20220331151556724.png)

**<font color='red'>结果如下所示：就是获取不到...</font>**



![image-20220331151533585](D:\GitTool\同步笔记\Typora_images\image-20220331151533585.png)
...
![image-20220331161901852](D:\GitTool\同步笔记\Typora_images\image-20220331161901852.png)
...
准备一个test变量：
![image-20220331154134075](D:\GitTool\同步笔记\Typora_images\image-20220331154134075.png)

随便在一个函数中改变这个变量的值

![image-20220331154211021](D:\GitTool\同步笔记\Typora_images\image-20220331154211021.png)

在钩子函数中调用该函数

![image-20220331154251335](D:\GitTool\同步笔记\Typora_images\image-20220331154251335.png)

写一个testClickt打印this.test变量，并在template中使用click事件触发这个函数。

![image-20220331154315432](D:\GitTool\同步笔记\Typora_images\image-20220331154315432.png)

结果：获取到的数据是最新的。

![image-20220331154427948](D:\GitTool\同步笔记\Typora_images\image-20220331154427948.png)
...
![image-20220331163319967](D:\GitTool\同步笔记\Typora_images\image-20220331163319967.png)
...
![image-20220331193314100](D:\GitTool\同步笔记\Typora_images\image-20220331193314100.png)

==解决：设置z-index就可以了==

![image-20220331193424216](D:\GitTool\同步笔记\Typora_images\image-20220331193424216.png)
...
![image-20220331210617925](D:\GitTool\同步笔记\Typora_images\image-20220331210617925.png)
...
![image-20220401093805432](D:\GitTool\同步笔记\Typora_images\image-20220401093805432.png)



![image-20220401093915600](D:\GitTool\同步笔记\Typora_images\image-20220401093915600.png)
...
![image-20220402111651986](D:\GitTool\同步笔记\Typora_images\image-20220402111651986.png)
...
![image-20220402145225883](D:\GitTool\同步笔记\Typora_images\image-20220402145225883.png)

**<font color='purple'>这里本来应该是五个分页才对啊，怎么变成10个了？？？</font>**

**<font color='purple'>解决：这里函数用错了：是slice而不是splice函数！！！</font>**

![image-20220402155117926](D:\GitTool\同步笔记\Typora_images\image-20220402155117926.png)



改成slice函数就行了：
![image-20220402155231973](D:\GitTool\同步笔记\Typora_images\image-20220402155231973.png)
...
![image-20220403092038713](D:\GitTool\同步笔记\Typora_images\image-20220403092038713.png)
...
![image-20220403103130107](D:\GitTool\同步笔记\Typora_images\image-20220403103130107.png)



![image-20220403104016264](D:\GitTool\同步笔记\Typora_images\image-20220403104016264.png)
...
![image-20220404121043380](D:\GitTool\同步笔记\Typora_images\image-20220404121043380.png)



css属性值的变量化：

![image-20220404121310151](D:\GitTool\同步笔记\Typora_images\image-20220404121310151.png)

这个路径是获取不到的。

![image-20220404121334763](D:\GitTool\同步笔记\Typora_images\image-20220404121334763.png)
...
**解决：用下面的路径就行了：**
![image-20220404140533069](D:\GitTool\同步笔记\Typora_images\image-20220404140533069.png)

**<font color='purple'>因为webpack会打包编译整个项目文件的，所以原来的路径就找不到了，看看跑起来的项目中的打包后的路径：</font>**

![image-20220404140749304](D:\GitTool\同步笔记\Typora_images\image-20220404140749304.png)
...
![image-20220404140947039](D:\GitTool\同步笔记\Typora_images\image-20220404140947039.png)



bug原因：

![image-20220404141011590](D:\GitTool\同步笔记\Typora_images\image-20220404141011590.png)
...
![image-20220405091131425](D:\GitTool\同步笔记\Typora_images\image-20220405091131425.png)

**<font color='purple'>点击背景的切换时，会闪过一片的白的然后才完成图片的加载对吧，这个太刺眼了，所以只要把背景颜色的白色改成灰色就行了，就会柔和一点。</font>**

![image-20220405091315930](D:\GitTool\同步笔记\Typora_images\image-20220405091315930.png)
...
![image-20220405170544378](D:\GitTool\同步笔记\Typora_images\image-20220405170544378.png)
...
![image-20220405213345311](D:\GitTool\同步笔记\Typora_images\image-20220405213345311.png)
...
![image-20220405215904366](D:\GitTool\同步笔记\Typora_images\image-20220405215904366.png)

**我把这个事件写在了这个小框框当中。。。**

![image-20220405215944951](D:\GitTool\同步笔记\Typora_images\image-20220405215944951.png)
...
![image-20220407125818828](D:\GitTool\同步笔记\Typora_images\image-20220407125818828.png)
...
![image-20220407204226203](D:\GitTool\同步笔记\Typora_images\image-20220407204226203.png)
...
![image-20220409184948224](D:\GitTool\同步笔记\Typora_images\image-20220409184948224.png)

**<font color='red'>这时候删除这条记录，如果还保留原来的页码去访问后端的话就会出bug的！，所以还是增加和修改一样，直接回到第一页不就行了，这么折磨干什么呢？</font>**

![image-20220409185509622](D:\GitTool\同步笔记\Typora_images\image-20220409185509622.png)

**直接重新刷新然后更新页码就行了。**

![image-20220409193838761](D:\GitTool\同步笔记\Typora_images\image-20220409193838761.png)
...
![image-20220410151025671](D:\GitTool\同步笔记\Typora_images\image-20220410151025671.png)
...
![image-20220410163726338](D:\GitTool\同步笔记\Typora_images\image-20220410163726338.png)

**<font color='purle'>原因：因为这个input输入框的类型是file类型的，然后你把value设置成一个字符串，当然会报错啊！</font>**

![image-20220410163856128](D:\GitTool\同步笔记\Typora_images\image-20220410163856128.png)
...
![image-20220411083915436](D:\GitTool\同步笔记\Typora_images\image-20220411083915436.png)
...
![image-20220411084504319](D:\GitTool\同步笔记\Typora_images\image-20220411084504319.png)
...
![image-20220412144151312](D:\GitTool\同步笔记\Typora_images\image-20220412144151312.png)



**==<font color='red'>前端bug</font>==**

![image-20220412144403298](D:\GitTool\同步笔记\Typora_images\image-20220412144403298.png)
...
![image-20220412145940116](D:\GitTool\同步笔记\Typora_images\image-20220412145940116.png)

![image-20220412150007164](D:\GitTool\同步笔记\Typora_images\image-20220412150007164.png)



结果：
![image-20220412150024328](D:\GitTool\同步笔记\Typora_images\image-20220412150024328.png)

**<font color='purple'>原来是.jpg大写了，我草！！！</font>**

![image-20220412150149407](D:\GitTool\同步笔记\Typora_images\image-20220412150149407.png)
...
![image-20220412171641421](D:\GitTool\同步笔记\Typora_images\image-20220412171641421.png)
...
![image-20220412181030680](D:\GitTool\同步笔记\Typora_images\image-20220412181030680.png)
...
解决：
![image-20220412181547027](D:\GitTool\同步笔记\Typora_images\image-20220412181547027.png)
...
![image-20220412204632808](D:\GitTool\同步笔记\Typora_images\image-20220412204632808.png)
...
![image-20220412210645688](D:\GitTool\同步笔记\Typora_images\image-20220412210645688.png)

![image-20220412211658398](D:\GitTool\同步笔记\Typora_images\image-20220412211658398.png)
...
![image-20220413094952328](D:\GitTool\同步笔记\Typora_images\image-20220413094952328.png)
...
![image-20220413102243597](D:\GitTool\同步笔记\Typora_images\image-20220413102243597.png)
...
![image-20220413135534446](D:\GitTool\同步笔记\Typora_images\image-20220413135534446.png)
...
![image-20220413151727438](D:\GitTool\同步笔记\Typora_images\image-20220413151727438.png)

**<font color='red'>像这样子的报错一定是mybatis.xml配置文件中的sql语句出错了。。。</font>**

**解决：原来是字段的大小写处错了捏...说明数据库对字段的大小写是敏感的！！！**

![image-20220413151828152](D:\GitTool\同步笔记\Typora_images\image-20220413151828152.png)
...
![image-20220413153120585](D:\GitTool\同步笔记\Typora_images\image-20220413153120585.png)

**看不懂捏？？**

**解决**

![image-20220413153328999](D:\GitTool\同步笔记\Typora_images\image-20220413153328999.png)
...
![image-20220413185307033](D:\GitTool\同步笔记\Typora_images\image-20220413185307033.png)

**这个设备要能正常运转才行！**

==如果这里显示摄像头是禁用的状态，可以通过 驱动程序选项卡，启用摄像头==

![image-20220413185517775](D:\GitTool\同步笔记\Typora_images\image-20220413185517775.png)
...
![image-20220414162336517](D:\GitTool\同步笔记\Typora_images\image-20220414162336517.png)
...
![image-20220414163524530](D:\GitTool\同步笔记\Typora_images\image-20220414163524530.png)
...
![image-20220414164547044](D:\GitTool\同步笔记\Typora_images\image-20220414164547044.png)
