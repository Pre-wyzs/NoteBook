...
**先git pull 同步本地仓库和远程仓库的所有内容【远程覆盖本地】，然后再改本地的，在提交就行了！**

**<font color='red'>问题：git pull 有时候会不成功的，因为有时候你就算是多空了一行，改了几个错别字什么的，都会导致本地内容和远程内容有冲突的，所以这个时候就要设置git config ...的内容了，主要如下：</font>**

![image-20220529181546088](Typora_images/Git版本管理/image-20220529181546088.png)

一般执行第一个 merge合并就行了，再pull就Ok了



## 9.6、上墅提交经验

- ==从根本上上来说，是把新的东西提交到远程仓库中保管；那当远程仓库中有本地没有的东西怎么办呢？先add & commit把自己的新东西提交到本地的版本库，再git pull一下把没有的东西拉下来，最后在git push提交到远程仓库中就行了==



- **<font color='red'>始终要保证 自己本地工作区的势 > 远程仓库的势才行！</font>**
